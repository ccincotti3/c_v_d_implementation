...
**DATR-1203:** Aim for **5-7 minutes**. There will be a **hard cutoff** at **8 minutes**. I want to reward preparing against these expectations, so these times **will not change** even if we have fewer presenters than we are anticipating at this point.
